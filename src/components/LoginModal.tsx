        ...
        >
          ...
          {clicked ? (
            <>
              ...
              <p className="leading-4 text-sm text-gray-600 dark:text-gray-300">
                Welcome to TechMart! This is a demo application. Please use <b>techmart</b> as
                username & <b>demo2024</b> as password. You can find these
                credentials in the placeholder fields below.{" "}
                <span
                  className="text-purple-500 cursor-pointer hover:underline font-medium"
              ...
              <form onSubmit={submitForm} className="flex flex-col space-y-3">
                <div className="relative">
                  <input
                    ...
                    type="text"
                    placeholder="Your username here... (techmart)"
                ...
                <div className="relative">
                  <input
                    ...
                    type="password"
                    placeholder="Your password here... (demo2024)"
                    className="border w-full border-black py-2 px-8 rounded dark:bg-slate-600"
                  />
